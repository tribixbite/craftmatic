#!/usr/bin/env bun
/**
 * Render v66 voxelized buildings as isometric exteriors.
...
const outDir = join(tilesDir, 'render-v66');
...
for (const name of BUILDINGS) {
  ...
  const schemPath = join(tilesDir, `${name}-v66.schem`);
...
console.log('\nDone! Check output/tiles/render-v66/');
