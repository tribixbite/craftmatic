#!/usr/bin/env bun
/**
 * Create v67 grading composites: satellite reference | isometric render
...
const renderDir = join(tilesDir, 'render-v67');
const gradeDir = join(tilesDir, 'grade-v67');
...
console.log('\nDone! Check output/tiles/grade-v67/');
