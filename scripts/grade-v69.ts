#!/usr/bin/env bun
/**
 * Create v69 grading composites: satellite reference | isometric render
...
const renderDir = join(tilesDir, 'render-v69');
const gradeDir = join(tilesDir, 'grade-v69');
...
console.log('\nDone! Check output/tiles/grade-v69/');
