...
// ─── Component & pillar cleanup ─────────────────────────────────────────────

/**
 * Remove thin vertical pillars (poles, antennae, lamp posts) that survive
 * connected-component filtering because they're large enough by voxel count
 * but have a tiny XZ cross-section that doesn't belong to the main building.
 *
