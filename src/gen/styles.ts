...
export const STYLES: Record<StyleName, StylePalette> = {
  ...
  gothic: {
    ...
    wallAccent: 'minecraft:polished_deepslate',
    interiorWall: 'minecraft:deepslate_bricks',
    floorGround: 'minecraft:polished_blackstone',
    floorUpper: 'minecraft:polished_blackstone',
    ceiling: 'minecraft:deepslate_tiles',
    timber: 'minecraft:deepslate_brick_wall',
    timberX: 'minecraft:polished_deepslate',
    timberZ: 'minecraft:polished_deepslate',
    roofN: 'minecraft:deepslate_brick_stairs[facing=north]',
    roofS: 'minecraft:deepslate_brick_stairs[facing=south]',
    roofCap: 'minecraft:deepslate_brick_slab[type=bottom]',
  ...
  rustic: {
    ...
    floorGround: 'minecraft:spruce_planks',
