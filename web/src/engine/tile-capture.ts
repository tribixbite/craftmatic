  ...
  return new Promise((resolve) => {
    ...
    const check = () => {
      try {
        ...
        // `stats` exists at runtime but the 3d-tiles-renderer typings omit it.
        const tilesStats = (tiles as unknown as { stats: Record<string, number> | null }).stats;
