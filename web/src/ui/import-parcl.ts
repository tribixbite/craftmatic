/**
 * Parcl Labs API integration — fetch real property data from address.
 * Requires PARCL_API_KEY (free tier at https://app.parcllabs.com).
 * Key is stored in localStorage for persistence across sessions.
 */

const STORAGE_KEY = 'craftmatic_parcl_api_key';
...
export function setParclApiKey(key: string): void {
  if (key.trim()) {
...
/**
 * Map Parcl property_type string to our form property types.
