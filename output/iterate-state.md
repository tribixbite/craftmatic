...
**Updated**: 2026-03-14T13:51:06.459Z
...
| sandiego | medium | 8.8 | 3/5 | 24 | 2.8 | 2.8 | 2.9 | FAIL | footprint(2.8/4) |
| arlington | medium | 10 | 3/5 | 6 | 4.0 | 3.0 | 3.0 | PASS | passing |
| raleigh | medium | 10 | 3/5 | 12 | 4.0 | 2.9 | 3.0 | PASS | passing |

## Action Items

- [ ] **sandiego** (8.8): Improve footprint (post-mask, 2x res, tighter dilate).
